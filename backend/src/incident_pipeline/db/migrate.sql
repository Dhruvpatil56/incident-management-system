-- Migration SQL for docker-entrypoint-initdb.d
...
CREATE INDEX IF NOT EXISTS idx_incidents_hash ON incidents(hash);
CREATE INDEX IF NOT EXISTS idx_incidents_rca_category ON incidents(rca_category);
